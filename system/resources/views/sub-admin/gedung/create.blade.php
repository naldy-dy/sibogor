	...
	<div class="card">
		<div class="shadow card-body pt-5 pb-0">
			<div class="form-validation">
				<form class="form-valide" action="{{url('sub-admin')}}/gedung/update" method="post" enctype="multipart/form-data">
					@csrf
					<div class="row">
						<div class="col-xl-12 col-md-12">
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="val-username" name="nama" placeholder="Nama Gedung" required="">
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="number" class="form-control" id="val-username" name="harga" placeholder="Harga Boking Gedung" required="">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="file" class="form-control" name="foto" placeholder="Nama Gedung" required="" accept="image/*">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<textarea class="form-control" id="val-suggestions" name="alamat" rows="5" placeholder="Alamat Lengkap"></textarea>
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="val-username" name="latitude" placeholder="Latitude" required="">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" id="val-username" name="longitude" placeholder="Longitude" required="">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-lg-8">
									<textarea class="form-control" id="val-suggestions" name="deskripsi" rows="5" placeholder="Deskripsikan Gedung Anda"></textarea>
								</div>
							</div>

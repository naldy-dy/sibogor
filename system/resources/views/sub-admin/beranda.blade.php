...
<div class="container-fluid">
	...
	<div class="alert alert-success alert-dismissible fade show" role="alert">
		...
		<hr>
		<p class="mb-0">Semoga rizki hari ini melimpah untuk-mu :).</p>
						...
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Jumlah Gedung</p>
									<span class="title text-black font-w600">{{$gedung}} Gedung</span>
								</div>
							</div>
						...
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									...
									<span class="title text-black font-w600">{{$pengguna}}</span>
								</div>
							</div>
							<div class="progress" style="height:5px;">
					...
					<div class="card avtivity-card">
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Admin Gedung</p>
					...
					<div class="card avtivity-card">
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Jumlah Transaksi</p>
									<span class="title text-black font-w600">{{$penyewaan}}</span>
								</div>
							</div>
							<div class="progress" style="height:5px;">

			...
			<div class="table-responsive">
				<table id="example" class="display table-hover table-datatable table ">
					...
					<tr>
						...
						<td>
							<div class="btn-group">
								<button type="button" class="btn btn-sm light btn-primary" data-toggle="modal" data-target="#info{{$k->idp}}"><i class="fa fa-info"></i></button>

								<button type="button" class="btn btn-sm light btn-primary" data-toggle="modal" data-target="#bukti{{$k->idp}}">
									<i class="fa fa-money"></i>
								</button>
								@include('sub-admin.utils.hapus', ['url' =>url('sub-admin/history', $k->idp)])
							</div>
						</td>
						...
						<td>
									...
									@if ($k->status == "Ditolak")
									<button class="btn btn-sm btn-danger">{{$k->status}}</button>
									@elseif ($k->status == "Disetujui")
									<button class="btn btn-sm btn-primary">{{$k->status}}</button>
									@elseif ($k->status == "Selesai")
									<button class="btn btn-sm btn-info">{{$k->status}}</button>

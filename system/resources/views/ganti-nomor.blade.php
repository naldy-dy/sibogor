      ...
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-md-7 animated fadeInDown card card-body shadow col-lg-5 col-xl-5 offset-xl-1">
          <div class="divider d-flex align-items-center my-4">
              <h3 class="text-center fw-bold mx-3 mb-0 text-muted">Ganti Nomor Handphone</h3>
            </div>


           @include('sub-admin.utils.notif')
              <p>Ganti Nomor Handphone anda pada form dibawah ini, pastikan nomor sudah terdaftar di whatsapp</p>
          
          <form action="{{url('otp',$user->id)}}/ganti-nomor" method="post">
            @csrf
            @method("PUT")
            <!-- Email input -->
            <div class="form-outline mb-4 mt-5">
              <input type="text" name="notlp" value="{{$user->notlp}}" id="form1Example13" class="form-control shadow" placeholder="Nomor Handphone" required />
            </div>

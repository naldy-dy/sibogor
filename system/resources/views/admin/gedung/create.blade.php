					...
					<div class="row">
						...
						<div class="col-md-6">
							<form class="form-valide" action="{{url('admin')}}/gedung/create" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<select class="form-control shadow" name="kecamatan" required="">
								...
								<div class="form-group">
									<input type="file" name="foto" class="form-control shadow" placeholder="Nama Gedung" accept="image/*" required="">
								</div>

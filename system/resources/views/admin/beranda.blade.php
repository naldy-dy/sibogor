		...
		<div class="col-xl-6 col-xxl-12">
			<div class="row">
				<div class="col-sm-6 col-xl-4 col-6 ">
					<div class="card shadow bg-success avtivity-card" style="color:#ffffff">
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									...
									<span class="title text-white font-w600">{{$gedung}}</span>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-6 col-xl-4 col-6 ">
					<div class="card avtivity-card bg-secondary">
						<div class="card-body">
							<div class="media align-items-center">
						...
						<div class="card-body bg-danger">
							<div class="media align-items-center">
								...
								<div class="media-body text-white">
									...
									<span class="title text-white font-w600">{{$pembayaran}}</span>
								</div>
							</div>
						</div>

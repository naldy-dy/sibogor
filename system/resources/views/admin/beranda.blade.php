						...
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Gedung</p>
									<span class="title text-black font-w600">{{$gedung}}</span>
								</div>
							</div>
					...
					<div class="card avtivity-card">
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Disewa Sebanyak</p>
									<span class="title text-black font-w600">{{$disewa}}x</span>
								</div>
							</div>
							<div class="progress" style="height:5px;">
					...
					<div class="card avtivity-card">
						<div class="card-body">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p class="fs-14 mb-2">Metode Pembayaran</p>
									<span class="title text-black font-w600">{{$pembayaran}}</span>
								</div>
							</div>
							<div class="progress" style="height:5px;">
